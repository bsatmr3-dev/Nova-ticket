...
class TicketManagementCog(commands.Cog):
    ...
    @app_commands.command(name="close", description="Close current ticket / إغلاق التذكرة")
    async def close(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message("🔒 Ticket closed. You can reopen or delete.")
